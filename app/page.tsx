...
export default function Home() {
  ...
  useEffect(()=>{if(!playing||framesLoading||view!=='globe')return;const timer=window.setTimeout(()=>setTimeMinutes(v=>historyMinutes.find(m=>m>v)??historyMinutes[0]??1440),1000);return()=>window.clearTimeout(timer)},[playing,framesLoading,timeMinutes,view,historyMinutes]);
