...
export default function Home() {
  ...
  useEffect(()=>{if(!playing||framesLoading||view!=='globe')return;const timer=window.setTimeout(()=>setTimeMinutes(v=>v>=1440?0:v+5),1000);return()=>window.clearTimeout(timer)},[playing,framesLoading,timeMinutes,view]);
