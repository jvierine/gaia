...
it than to any other. Within a cell the star's own fading is trusted fully at
the star and less further out, following a Hann window that reaches zero at the
cell boundary; at the boundary the value is the blend of the two cells meeting
there. That blend is spread over \SI{10}{px} with the same smooth step
...
it exists to carry. The result is continuous, equals a star's own fading at that
star, and equals the mean of two neighbours on the boundary between them.

Two consequences are worth stating because they are choices, not accidents. The
