...
\begin{enumerate}
  \item \textbf{Spend the optical depth.} It is stored
    (Sec.~\ref{sec:depth}) and, since this revision, readable
    (Sec.~\ref{sec:audit}); nothing yet acts on it. Two things should:
    \texttt{cloud\_weight} in the composite, and a cell value in the cloud map.
    This is now the only thing standing between the archive and a cloud-aware
    mosaic, and it is the next piece of work.
