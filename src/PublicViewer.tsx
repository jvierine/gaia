...
export default function PublicViewer(){
  ...
  return <main className="gaia-public">
    ...
    {credits&&<section className="public-info" role="dialog" aria-label="Information and credits">
      ...
      <p>Drag to rotate the globe. Scroll or pinch to zoom. Press Play to explore recent auroral activity, or Latest to see the newest images. Tick <strong>Sun up</strong> to look down on the north pole with the sun held upwards, so the planet rotates underneath the fixed sun&ndash;earth line.</p>
      ...
      <a className="credits-uit" href="https://uit.no/" target="_blank" rel="noreferrer"><img src="/gaia/uit-logo-white.png" alt="UiT The Arctic University of Norway"/></a>
      <p>The GAIA database, image aggregation, and geographic projection service are developed by Juha Vierinen and Björn Gustavsson at UiT The Arctic University of Norway. This affiliation applies only to the GAIA service; it does not imply UiT ownership, operation, endorsement, or sponsorship of any contributing camera network or its imagery.</p>
