...
['yr-brekke','Ortneset (Brekke), Vestland, Norway','https://www.yr.no/webcams/1/2000/ortneset/1.jpg','Original Brekke camera operator; image supplied through Yr','https://www.yr.no/',null,null,'SWL lists the identical URL twice with conflicting directions; village identified by Juha as Ortneset, Vestland, Norway; operator and exact camera coordinates need verification'],
